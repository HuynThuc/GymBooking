  ...
  return (
    <section className="bg-black py-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <span className="text-orange-500 text-sm uppercase tracking-wider">CHÚNG TÔI CUNG CẤP GÌ?</span>
      <h2 className="text-white text-4xl md:text-5xl font-bold mt-2">KHÁM PHÁ GIỚI HẠN MỚI CÙNG CHÚNG TÔI</h2>
