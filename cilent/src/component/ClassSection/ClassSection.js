...
const ClassSection = ({ serviceId, onEnrollNow }) => {
    ...
    return (
        <section className="max-w-7xl mx-auto px-4 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <button  onClick={() => onEnrollNow()} className="bg-[#f36100] hover:bg-blue-700 text-white font-bold py-3 px-6 rounded transition duration-300">Đặt Lớp Ngay</button>
            </div>
        </section>
    );
};
