...
function ThanhToan() {
  ...
  const { planId, price, trainerName, serviceName, selectedTimesFormatted, classDate, startTime } = location.state || {};

  console.log("date", classDate)
  console.log("date", selectedTimesFormatted)
  ...
  return (
    <div className="bg-white text-black">
      <BannerService
        isBooking={true}
        serviceName="Booking"
        bookingImage={bookingImage} // Hình ảnh đặt chỗ
      />
