...
import { RegisterUserDTO, GoogleUserDTO, UpdatePasswordDTO } from '../dto/register-user.dto';
...
async changePassword(userId: number, updatePasswordDTO: UpdatePasswordDTO): Promise<any> {
    ...
    if (!user) {
        // Trả về lỗi 404 nếu người dùng không tìm thấy
    ...
    if (!isOldPasswordValid) {
        // Trả về lỗi 400 nếu mật khẩu cũ không đúng
