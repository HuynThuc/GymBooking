...
export class MomoService {
    private config: MomoPaymentConfig = {
        ...
        partnerCode: 'MOMO',
        redirectUrl: 'http://localhost:3000/thank', //đường dẫn đến khi thanh toán thành công
        ipnUrl: ' https://0970-2405-4802-93b6-ff40-c409-3055-10e9-eb21.ngrok-free.app/payment/callback', //link call back trả về kết quả thành côcng
