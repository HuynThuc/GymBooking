...
export class OrderDetail {
    ...
    @ManyToOne(() => TrainerClass, trainerClass => trainerClass.orderDetails, { nullable: true })
    @JoinColumn({ name: 'trainer_class_id' })
    trainerClass?: TrainerClass; // Liên kết tới lớp học (TrainerClass)
